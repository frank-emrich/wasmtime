...
use wasmtime_environ::{
    ...
    ModuleTypesBuilder, PtrSize, Table, TableIndex, TripleExt, Tunables, TypeConvert,
            ...
            match ty.top() {
                ...
                WasmHeapTopType::Cont => {
                    ...
                    return Err(wasmtime_environ::WasmError::Unsupported(
                        "codegen for stack switching types not implemented, yet".to_string(),
                    ));
                }
...
/// code.
#[allow(dead_code, reason = "Dummy function to supress more dead code warnings")]
