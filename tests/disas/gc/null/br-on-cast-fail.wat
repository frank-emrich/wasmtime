...
;;
;;                                 block8:
;; @0034                               v36 = load.i64 notrap aligned readonly v0+80
;; @0034                               v37 = load.i64 notrap aligned readonly v0+96
;; @0034                               call_indirect sig1, v36(v37, v0)
;; @0036                               return
;;
;;                                 block2:
;; @0038                               v39 = load.i64 notrap aligned readonly v0+104
;; @0038                               v40 = load.i64 notrap aligned readonly v0+120
